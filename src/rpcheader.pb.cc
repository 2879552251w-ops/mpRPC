...
namespace rpcheader {
PROTOBUF_CONSTEXPR RequreMsg::RequreMsg(
...
struct RequreMsgDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RequreMsgDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~RequreMsgDefaultTypeInternal() {}
  union {
    RequreMsg _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RequreMsgDefaultTypeInternal _RequreMsg_default_instance_;
}  // namespace rpcheader
...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rpcheader::RequreMsg, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::rpcheader::RequreMsg, _impl_.service_name_),
  PROTOBUF_FIELD_OFFSET(::rpcheader::RequreMsg, _impl_.method_name_),
  PROTOBUF_FIELD_OFFSET(::rpcheader::RequreMsg, _impl_.args_size_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::rpcheader::RequreMsg)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::rpcheader::_RequreMsg_default_instance_._instance,
};
...
class RequreMsg::_Internal {
 public:
};

RequreMsg::RequreMsg(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:rpcheader.RequreMsg)
}
RequreMsg::RequreMsg(const RequreMsg& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RequreMsg* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:rpcheader.RequreMsg)
}

inline void RequreMsg::SharedCtor(
...
RequreMsg::~RequreMsg() {
  // @@protoc_insertion_point(destructor:rpcheader.RequreMsg)
...
inline void RequreMsg::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.service_name_.Destroy();
  _impl_.method_name_.Destroy();
}

void RequreMsg::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void RequreMsg::Clear() {
// @@protoc_insertion_point(message_clear_start:rpcheader.RequreMsg)
...
const char* RequreMsg::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* RequreMsg::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:rpcheader.RequreMsg)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rpcheader.RequreMsg)
  return target;
}

size_t RequreMsg::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rpcheader.RequreMsg)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RequreMsg::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    RequreMsg::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*RequreMsg::GetClassData() const { return &_class_data_; }


void RequreMsg::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RequreMsg*>(&to_msg);
  auto& from = static_cast<const RequreMsg&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:rpcheader.RequreMsg)
...
void RequreMsg::CopyFrom(const RequreMsg& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:rpcheader.RequreMsg)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RequreMsg::IsInitialized() const {
  return true;
}

void RequreMsg::InternalSwap(RequreMsg* other) {
  using std::swap;
...
::PROTOBUF_NAMESPACE_ID::Metadata RequreMsg::GetMetadata() const {
...
template<> PROTOBUF_NOINLINE ::rpcheader::RequreMsg*
Arena::CreateMaybeMessage< ::rpcheader::RequreMsg >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rpcheader::RequreMsg >(arena);
}
